...
import { getHistory, getChatPrimaryType } from "../utils/historyStorage";
...
export default function Dashboard() {
  ...
  const pieSlices = pieData.map(([type, count], i) => {
    ...
    const colors = ["#7c3aed", "#22c55e", "#0ea5e9", "#f97316", "#ec4899"];
            ...
            : quality.sentiment === "Negative"
              ...
              <div className="h-3 rounded-full bg-black/10 dark:bg-white/10 mb-6">
                <div
                  ...
                  style={{
                    width: `${Math.abs(quality.sentiment_score) * 100}%`,
                  }}
                />
              </div>
              ...
              s.severity === "High"
                ...
                : s.severity === "Medium"
                  ...
                  : "bg-green-500/20 text-green-600"
                      ...
                      <p className="text-xs opacity-60 pl-7">{s.reason}</p>
