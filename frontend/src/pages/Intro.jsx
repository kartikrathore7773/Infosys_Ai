    ...
    <div className="w-full bg-[#0b0b14] text-white overflow-hidden">
      ...
      >
        <div className="flex gap-8 text-sm font-medium">
          <a href="#explore" className="hover:text-purple-400">
            Explore
          </a>
          ...
          <Link to="/sign" className="hover:text-purple-400">
            Sign In
          </Link>
        </div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto space-y-36 perspective-[1600px]">
          <StackCard
            title="Blog Writing"
            desc="SEO-optimized long-form blogs with structure & clarity."
            image="/blog.png"
            align="right"
          />
          <StackCard
            title="LinkedIn Content"
            desc="Professional posts built for reach & engagement."
            image="/linkedin.png"
            align="left"
          />
          <StackCard
            title="Advertisements"
            desc="High-converting ad copies for all platforms."
            image="/advertisment.png"
            align="right"
          />
          <StackCard
            title="Email Campaigns"
            desc="Cold emails & newsletters that convert."
            image="/email.png"
            align="left"
          />
          <StackCard
            title="Tweet Generator"
            desc="Short, viral tweets crafted for engagement."
            image="/tweet.png"
            align="right"
          />
        </div>
      ...
      <section id="contact" className="bg-[#0b0b14] py-36 text-center">
        ...
        >
          If you are passionate about tackling some most interesting content, we
      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-10 left-10 z-10 max-w-lg">
            <h4 className="text-4xl font-bold mb-3 tracking-wide">{title}</h4>
