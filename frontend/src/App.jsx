...
import { hydrateHistoryFromServer } from "./utils/historyStorage";
...
function AppRoutes() {
  ...
  return (
    <>
      ...
      <Routes>
        {/* Landing */}
        <Route path="/" element={isLoggedIn ? <Home /> : <Intro />} />

        {/* Home */}
        <Route path="/home" element={isLoggedIn ? <Home /> : <Sign />} />
        ...
        <Route path="/profile" element={isLoggedIn ? <Profile /> : <Sign />} />
